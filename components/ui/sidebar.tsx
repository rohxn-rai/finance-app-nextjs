      ...
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={cn(
            ...
            "has-data-[variant=inset]:bg-sidebar flex ",
            "min-h-svh w-full",
            className
          )}
          {...props}
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      className={cn(
        "hover:after:bg-sidebar-border absolute inset-y-0 ",
        "z-20 hidden w-4 -translate-x-1/2 transition-all ",
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "flex h-8 shrink-0 items-center rounded-md ",
        "px-2 text-xs font-medium outline-hidden ",
        "transition-[margin,opacity] duration-200 ",
        "ease-linear focus-visible:ring-2 ",
...
const sidebarMenuButtonVariants = cva(
  cn(
    ...
    "gap-2 overflow-hidden rounded-md p-2 ",
